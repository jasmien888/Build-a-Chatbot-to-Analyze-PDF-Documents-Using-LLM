...
def init_llm():
    ...
    api_key="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"
    # ---> TODO: write your code here <----
    llm = OpenAI(model_name="gpt-3.5-turbo", openai_api_key=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)
    # Initialize the embeddings for the language model
    llm_embeddings = OpenAIEmbeddings(openai_api_key=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)
